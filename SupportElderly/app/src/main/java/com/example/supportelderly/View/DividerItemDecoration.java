...
/**
 * Klasa dotycząca divider-a dla listy alarmów i edycji alarmów, gdzie divider również jest wykorzystywany.
 */
public final class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private DividerItemDecoration(Context context, Drawable divider) {
