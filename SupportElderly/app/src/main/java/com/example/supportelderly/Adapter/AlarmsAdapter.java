...
import com.example.supportelderly.UI.EditSettingsForAlarmActivity;
import com.example.supportelderly.Util.AlarmUtils;

import java.util.List;

/**
 * Adapter dotyczący listy alarmów (przygotowanie widoku).
 */
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Bitmap alarmImage = alarm.getImage();

        if (alarmImage == null) {
            holder.imageV.setImageResource(R.drawable.medicine_icon);
        } else {
            holder.imageV.setImageBitmap(alarmImage);
        }
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            final Intent launchEditAlarmIntent =
                    EditSettingsForAlarmActivity.buildAddEditAlarmActivityIntent(
                            c1, EditSettingsForAlarmActivity.EDIT_ALARM
                    );
            launchEditAlarmIntent.putExtra(EditSettingsForAlarmActivity.ALARM_EXTRA, alarm);
    ...
    static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            imageV = itemView.findViewById(R.id.ar_repeat_icon);
