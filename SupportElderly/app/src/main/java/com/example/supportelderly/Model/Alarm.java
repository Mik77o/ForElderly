...
import static com.example.supportelderly.Helpers.ConverterForImageClassHelper.convertBitmapToByteArray;
...
public final class Alarm implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        convertBitmapToByteArray(image, parcel);
    ...
    public Alarm(long id, long time, String label, Bitmap image, @Days int... days) {
        this.id = id;
        this.time = time;
        this.label = label;
        this.image = image;
